...
from fake_stake.base_test import TERRACREDIT_FakeStakeTest
from time import sleep

class zPoSFakeStakeAccepted(TERRACREDIT_FakeStakeTest):
    ...
    def set_test_params(self):
        ...
        self.num_nodes = 1
        self.extra_args = [['-staking=1', '-debug=net', '-zcreditstake']] * self.num_nodes
