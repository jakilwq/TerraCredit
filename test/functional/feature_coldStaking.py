...
from test_framework.terracredit_node import TerraCreditTestNode
...
class TERRACREDIT_ColdStakingTest(BitcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(TerraCreditTestNode())
...
if __name__ == '__main__':
    TERRACREDIT_ColdStakingTest().main()
