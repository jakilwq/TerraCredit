...
#ifndef TERRACREDIT_ZCREDITTRACKER_H
#define TERRACREDIT_ZCREDITTRACKER_H
...
public:
    CzCREDITTracker(std::string strWalletFile);
    ~CzCREDITTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzCREDITWallet* zCREDITWallet = NULL);
...
#endif //TERRACREDIT_ZCREDITTRACKER_H
