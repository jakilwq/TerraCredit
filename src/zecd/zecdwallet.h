...
#ifndef TERRACREDIT_ZCREDITWALLET_H
#define TERRACREDIT_ZCREDITWALLET_H
...
public:
    CzCREDITWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZCREDIT(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZCREDIT(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //TERRACREDIT_ZCREDITWALLET_H
