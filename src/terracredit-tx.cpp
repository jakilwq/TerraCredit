...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TerraCredit Core terracredit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  terracredit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded terracredit transaction") + "\n" +
                               "  terracredit-tx [options] -create [commands]   " + _("Create hex-encoded terracredit transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded terracredit transaction
