 ...
 * instead if you have the choice (see secp256k1_creditsa_signature_parse_der and
 * secp256k1_creditsa_signature_parse_compact).
 *
 ...
 */
int creditsa_signature_parse_der_lax(
