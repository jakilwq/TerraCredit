/* src/config/terracredit-config.h.  Generated from terracredit-config.h.in by configure.  */
/* src/config/terracredit-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CREDIT_CONFIG_H

#define CREDIT_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/terracredit-project/terracredit/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "TERRACREDIT Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "TERRACREDIT Core 1.3.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "terracredit"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://terra-credit.com/"
