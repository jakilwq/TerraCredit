...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, TERRACREDITGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, TERRACREDITGUI *gui, double posX = 3);
