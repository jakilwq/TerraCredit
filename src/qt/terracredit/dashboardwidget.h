...
#include "config/terracredit-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qreal maxValue = 0;
    qint64 totalCredit = 0;
    qint64 totalZcredit = 0;
    QList<qreal> valuesCredit;
    QList<qreal> valueszCredit;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(TERRACREDITGUI* _window);
    ~DashboardWidget();
