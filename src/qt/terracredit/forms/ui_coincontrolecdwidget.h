/********************************************************************************
** Form generated from reading UI file 'coincontrolcreditwidget.ui'
**
...
#ifndef UI_COINCONTROLCREDITWIDGET_H
#define UI_COINCONTROLCREDITWIDGET_H
...
class Ui_CoinControlCreditWidget
{
public:
    ...
    void setupUi(QWidget *CoinControlCreditWidget)
    {
        if (CoinControlCreditWidget->objectName().isEmpty())
            CoinControlCreditWidget->setObjectName(QStringLiteral("CoinControlCreditWidget"));
        CoinControlCreditWidget->resize(918, 552);
        CoinControlCreditWidget->setStyleSheet(QStringLiteral(""));
        verticalLayout_2 = new QVBoxLayout(CoinControlCreditWidget);
        verticalLayout_2->setSpacing(0);
        verticalLayout_2->setObjectName(QStringLiteral("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        frameContainer = new QFrame(CoinControlCreditWidget);
        ...
        retranslateUi(CoinControlCreditWidget);

        QMetaObject::connectSlotsByName(CoinControlCreditWidget);
    } // setupUi

    void retranslateUi(QWidget *CoinControlCreditWidget)
    {
        CoinControlCreditWidget->setWindowTitle(QApplication::translate("CoinControlCreditWidget", "Dialog", Q_NULLPTR));
        labelTitle->setText(QApplication::translate("CoinControlCreditWidget", "Transaction Details", Q_NULLPTR));
        btnEsc->setText(QApplication::translate("CoinControlCreditWidget", "PushButton", Q_NULLPTR));
        labelTitleAmount->setText(QApplication::translate("CoinControlCreditWidget", "CREDIT:", Q_NULLPTR));
        labelValueAmount->setText(QApplication::translate("CoinControlCreditWidget", "TextLabel", Q_NULLPTR));
        labelTitleQuantity->setText(QApplication::translate("CoinControlCreditWidget", "Quantity:", Q_NULLPTR));
        labelValueQuantity->setText(QApplication::translate("CoinControlCreditWidget", "TextLabel", Q_NULLPTR));
        labelTitleFee->setText(QApplication::translate("CoinControlCreditWidget", "Fee:", Q_NULLPTR));
        labelValueFee->setText(QApplication::translate("CoinControlCreditWidget", "TextLabel", Q_NULLPTR));
        labelTitleDenom->setText(QApplication::translate("CoinControlCreditWidget", "Amount", Q_NULLPTR));
        labelTitleId->setText(QApplication::translate("CoinControlCreditWidget", "Label", Q_NULLPTR));
        labelTitleVersion->setText(QApplication::translate("CoinControlCreditWidget", "Address", Q_NULLPTR));
        labelTitleType->setText(QApplication::translate("CoinControlCreditWidget", "Type", Q_NULLPTR));
        labelTitleSpen->setText(QApplication::translate("CoinControlCreditWidget", "Date", Q_NULLPTR));
        labelTitleConfirmations->setText(QApplication::translate("CoinControlCreditWidget", "Confirmations", Q_NULLPTR));
        checkBoxAll->setText(QApplication::translate("CoinControlCreditWidget", "CheckBox", Q_NULLPTR));
        labelTitleBytes->setText(QApplication::translate("CoinControlCreditWidget", "Bytes:", Q_NULLPTR));
        labelValueBytes->setText(QApplication::translate("CoinControlCreditWidget", "TextLabel", Q_NULLPTR));
        labelTitleDust->setText(QApplication::translate("CoinControlCreditWidget", "Dust:", Q_NULLPTR));
        labelValueDust->setText(QApplication::translate("CoinControlCreditWidget", "TextLabel", Q_NULLPTR));
        labelTitleChange->setText(QApplication::translate("CoinControlCreditWidget", "Change:", Q_NULLPTR));
        labelValueChange->setText(QApplication::translate("CoinControlCreditWidget", "TextLabel", Q_NULLPTR));
        labelTitleAfter->setText(QApplication::translate("CoinControlCreditWidget", "After Fee: ", Q_NULLPTR));
        labelValueAfter->setText(QApplication::translate("CoinControlCreditWidget", "TextLabel", Q_NULLPTR));
        btnCancel->setText(QApplication::translate("CoinControlCreditWidget", "CANCEL", Q_NULLPTR));
        btnSave->setText(QApplication::translate("CoinControlCreditWidget", "OK", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class CoinControlCreditWidget: public Ui_CoinControlCreditWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_COINCONTROLCREDITWIDGET_H
