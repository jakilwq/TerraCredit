...
#include "qt/terracredit/forms/ui_coldstakingwidget.h"
#include "qt/terracredit/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/terracredit/requestdialog.h"
#include "qt/terracredit/tooltipmenu.h"
...
#include "qt/terracredit/csrow.h"
...
ColdStakingWidget::ColdStakingWidget(TERRACREDITGUI* parent) :
    PWidget(parent),
    ui(new Ui::ColdStakingWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your CREDITs and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept CREDIT delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select CREDIT outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 CREDIT" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
