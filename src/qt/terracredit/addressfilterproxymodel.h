...
#ifndef TERRACREDIT_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define TERRACREDIT_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //TERRACREDIT_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
