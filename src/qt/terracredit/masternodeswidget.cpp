...
#include "qt/terracredit/forms/ui_masternodeswidget.h"
#include "qt/terracredit/qtutils.h"
#include "qt/terracredit/mnrow.h"
#include "qt/terracredit/mninfodialog.h"

#include "qt/terracredit/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(TERRACREDITGUI *parent) :
    PWidget(parent),
    ...
    if (boost::filesystem::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:32001 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked(){
    if(verifyWalletUnlocked()) {
        if(walletModel->getBalance() <= (Params().MasternodeCollateral())){
            inform(tr("Not enough balance to create a masternode, 100,000 CREDIT required."));
            return;
        }
        showHideOp(true);
