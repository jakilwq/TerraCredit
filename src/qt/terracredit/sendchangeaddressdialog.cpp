...
#include "qt/terracredit/forms/ui_sendchangeaddressdialog.h"
    ...
    ui(new Ui::SendChangeAddressDialog)
{
    ...
    ui->labelMessage->setText(tr("The remainder of the value resultant from the inputs minus the outputs value goes to the \"change\" TERRACREDIT address"));
    ui->labelMessage->setProperty("cssClass", "text-main-grey");

    ui->lineEditAddress->setPlaceholderText("Enter a TERRACREDIT  address (e.g E7VFR83SQbiezrW72hjc… ");
