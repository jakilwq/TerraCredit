...
#include "qt/terracredit/forms/ui_masternodewizarddialog.h"
    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 32001");
    ...
    if(walletModel->isTestNetwork()){
        ...
        ui->lineEditPort->setText("32003");
    } else {
        ui->lineEditPort->setText("32001");
    }
