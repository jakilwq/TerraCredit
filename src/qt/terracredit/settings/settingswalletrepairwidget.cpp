...
#include "qt/terracredit/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/terracredit/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(TERRACREDITGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to TERRACREDITGUI::handleRestart()
