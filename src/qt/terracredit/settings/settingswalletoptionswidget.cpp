...
#include "qt/terracredit/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/terracredit/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(TERRACREDITGUI* _window, QWidget *parent) :
