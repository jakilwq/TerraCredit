...
#include "qt/terracredit/settings/settingsnetworkwidget.h"
#include "qt/terracredit/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/terracredit/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(TERRACREDITGUI* _window, QWidget *parent) :
