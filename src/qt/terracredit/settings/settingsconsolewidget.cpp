...
#include "qt/terracredit/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/terracredit/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(TERRACREDITGUI* _window, QWidget *parent) :
