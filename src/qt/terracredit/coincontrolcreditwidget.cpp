...
#include "qt/terracredit/forms/ui_coincontrolcreditwidget.h"

CoinControlCreditWidget::CoinControlCreditWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlCreditWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select CREDIT Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("CREDIT");
    ...
    ui->labelValueAfter->setText("0.00 CREDIT");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 CREDIT");
    ui->labelValueFee->setText("0.00 CREDIT");
...
CoinControlCreditWidget::~CoinControlCreditWidget()
{
    delete ui;
}
