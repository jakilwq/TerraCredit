...
#include "qt/terracredit/forms/ui_receivewidget.h"
...
#include "qt/terracredit/addressholder.h"
...
ReceiveWidget::ReceiveWidget(TERRACREDITGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive CREDIT."));
