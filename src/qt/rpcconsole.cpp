                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCREDITPathCustom = GetArg("-zcreditbackuppath", "");
    ...
    if(!strzCREDITPathCustom.empty()) {
        ui->wallet_customzcreditbackuppath->setText(QString::fromStdString(strzCREDITPathCustom));
        ui->wallet_customzcreditbackuppath_label->setVisible(true);
        ui->wallet_customzcreditbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCREDITPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the TERRACREDIT RPC console.") + "<br>" +
