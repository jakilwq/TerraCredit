 ...
 * TERRACREDIT system. There are three: the main network on which people trade goods
...
public:
    ...
    std::string GetBackboneAddress() const { return strBackboneAddr; }
    ...
    int TerraCreditBadBlockTime() const { return nTerraCreditBadBlockTime; }
    int TerraCreditBadBlocknBits() const { return nTerraCreditBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nTerraCreditBadBlockTime;
    unsigned int nTerraCreditBadBlocknBits;
