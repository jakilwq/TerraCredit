...
BOOST_AUTO_TEST_CASE(ripemd160_testvectors) {
    ...
    TestRIPEMD160("abcdbcdcreditefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
...
BOOST_AUTO_TEST_CASE(sha1_testvectors) {
    ...
    TestSHA1("abcdbcdcreditefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("abcdbcdcreditefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
...
BOOST_AUTO_TEST_CASE(sha512_testvectors) {
    ...
    TestSHA512("abcdbcdcreditefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
