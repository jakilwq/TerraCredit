...
/** zCREDIT precomputing variables
...
/**
 * Count CREDITSA signature operations the old-fashioned (pre-0.6) way
...
/**
 * Count CREDITSA signature operations in pay-to-script-hash inputs.
 *
 * @param[in] mapInputs Map of previous transactions that have outputs we're spending
