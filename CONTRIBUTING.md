Contributing to TERRACREDIT Core
============================

The TERRACREDIT Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/terracredit-project/terracredit/blob/master/doc/translation_process.md)
...
The following applies to code changes to the TERRACREDIT Core project, and is not to be
confused with overall TERRACREDIT Network Protocol consensus changes.

Whether a pull request is merged into TERRACREDIT Core rests with the project merge
...
Patches that change TERRACREDIT consensus rules are considerably more involved than
normal because they affect the entire creditsystem and so must be preceded by
...
Where a patchset proposes to change the TERRACREDIT consensus, it must have been
...
The project leader is the release manager for each TERRACREDIT Core release.
