...
The script [extract-osx-sdk.sh](https://github.com/terracredit-project/terracredit/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
terracredit/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/terracredit-project/terracredit/blob/master/doc/README_osx.md) for troubleshooting tips.