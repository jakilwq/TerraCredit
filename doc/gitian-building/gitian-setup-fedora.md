...
The build script we'll be using is contained in the TERRACREDIT github repository ([contrib/gitian-build.py](https://github.com/terracredit-project/terracredit/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the TERRACREDIT repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/TERRACREDIT-Project/TERRACREDIT/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, terracredit-detached-sigs, and terracredit GitHub repos.
