...
This document provides guidelines for internationalization of the TERRACREDIT Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to TERRACREDIT network</numerusform>
            <numerusform>%n active connections to TERRACREDIT network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `terracredit_en.ts` remains unchanged.
