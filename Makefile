...
pkgdatadir = $(datadir)/terracredit
pkgincludedir = $(includedir)/terracredit
pkglibdir = $(libdir)/terracredit
pkglibexecdir = $(libexecdir)/terracredit
...
CONFIG_HEADER = $(top_builddir)/src/config/terracredit-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/terracredit-config.h.in \
...
ACLOCAL = ${SHELL} /home/ksk/Works/2020/2020-06/2020-06-12_TerraCredit/works/Ubuntu_works/TerraCredit-1.0.0/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/ksk/Works/2020/2020-06/2020-06-12_TerraCredit/works/Ubuntu_works/TerraCredit-1.0.0/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/ksk/Works/2020/2020-06/2020-06-12_TerraCredit/works/Ubuntu_works/TerraCredit-1.0.0/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/ksk/Works/2020/2020-06/2020-06-12_TerraCredit/works/Ubuntu_works/TerraCredit-1.0.0/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = terracredit-cli
BITCOIN_DAEMON_NAME = terracreditd
BITCOIN_GUI_NAME = terracredit-qt
BITCOIN_TX_NAME = terracredit-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/ksk/Works/2020/2020-06/2020-06-12_TerraCredit/works/Ubuntu_works/TerraCredit-1.0.0/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_STRING = TERRACREDIT Core 1.1.0.1
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/ksk/Works/2020/2020-06/2020-06-12_TerraCredit/works/Ubuntu_works/TerraCredit-1.0.0
abs_srcdir = /home/ksk/Works/2020/2020-06/2020-06-12_TerraCredit/works/Ubuntu_works/TerraCredit-1.0.0
abs_top_builddir = /home/ksk/Works/2020/2020-06/2020-06-12_TerraCredit/works/Ubuntu_works/TerraCredit-1.0.0
abs_top_srcdir = /home/ksk/Works/2020/2020-06/2020-06-12_TerraCredit/works/Ubuntu_works/TerraCredit-1.0.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/ksk/Works/2020/2020-06/2020-06-12_TerraCredit/works/Ubuntu_works/TerraCredit-1.0.0/build-aux/install-sh
...
DIST_CONTRIB = $(top_srcdir)/contrib/terracredit-cli.bash-completion \
	       $(top_srcdir)/contrib/terracredit-tx.bash-completion \
	       $(top_srcdir)/contrib/terracreditd.bash-completion \
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/terracredit.ico \
  $(top_srcdir)/share/pixmaps/nsis-header.bmp \
  $(top_srcdir)/share/pixmaps/nsis-wizard.bmp \
  $(top_srcdir)/doc/README_windows.txt

LINUX_PACKAGING = $(top_srcdir)/share/pixmaps/terracredit16.xpm \
  $(top_srcdir)/share/pixmaps/terracredit32.xpm \
  $(top_srcdir)/share/pixmaps/terracredit128.png
...
COVERAGE_INFO = baseline.info \
  test_terracredit_filtered.info total_coverage.info \
  baseline_filtered.info functional_test.info functional_test_filtered.info \
  test_terracredit_coverage.info test_terracredit.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/TERRACREDIT-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/terracredit-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/terracredit-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/terracredit-config.h
$(top_srcdir)/src/config/terracredit-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/terracredit-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/TERRACREDIT-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/TERRACREDIT-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/TERRACREDIT-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_terracredit.info: baseline_filtered.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c $(LCOV_OPTS) -d $(abs_builddir)/src -t test_terracredit -o $@
#	$(LCOV) -z $(LCOV_OPTS) -d $(abs_builddir)/src

#test_terracredit_filtered.info: test_terracredit.info
#	$(abs_builddir)/contrib/filter-lcov.py $(LCOV_FILTER_PATTERN) $< $@
#	$(LCOV) -a $@ $(LCOV_OPTS) -o $@

#functional_test.info: test_terracredit_filtered.info
...
#test_terracredit_coverage.info: baseline_filtered.info test_terracredit_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_terracredit_filtered.info -o $@

#total_coverage.info: test_terracredit_filtered.info functional_test_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_terracredit_filtered.info -a functional_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_terracredit.coverage/.dirstamp:  test_terracredit_coverage.info
...
#cov: test_terracredit.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local: clean-docs
	rm -rf coverage_percent.txt test_terracredit.coverage/ total.coverage/ test/tmp/ cache/ $(OSX_APP)
